...
public class HashLinearProbingTest {
    ...
    public void AddingElemWithHashEqualsSize() {
        ...
        HashTable<String> hash = new HashLinearProbing<>(elem.hashCode());
    ...
    public void AddingElementsWithSameHashCode() {
        //given
        HashTable<Struct> hash = new HashLinearProbing<>(25);
    ...
    public void getElementNotThere() {
        //given
        HashTable<Double> hash = new HashLinearProbing<>(3);
        hash.put(1.0);
        hash.put(2.0);
        hash.put(3.0);
    ...
    public void DeletingFirstElementSameHashCode() {
        //given
        HashTable<Struct> hash = new HashLinearProbing<>(3);
    ...
    public void deletingAllOfElementsWithSameCode() {
        //given
        HashTable<Struct> hash = new HashLinearProbing<>(12);
