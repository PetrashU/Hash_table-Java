...
public class HashQuadraticProbingTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void should_ThrowExceptionWhenInitialConst_A_Is0() {
        // given
        int initialSize = 1;

        // when
        HashTable<Double> unusedHash = new HashQuadraticProbing<>(initialSize, 0, 1);
    ...
    @Test(expected = IllegalArgumentException.class)
    public void should_ThrowExceptionWhenInitialConst_B_Is0() {
        // given
        int initialSize = 1;

        // when
        HashTable<Double> unusedHash = new HashQuadraticProbing<>(initialSize, 1, 0);
    ...
    public void AddingElemWithHashEqualsSize() {
        ...
        HashTable<String> hash = new HashQuadraticProbing<>(elem.hashCode(), -1, 1);
    ...
    public void AddingElementsWithSameHashCode() {
        //given
        HashTable<Struct> hash = new HashQuadraticProbing<>(25, 1.5, 2);
    ...
    public void getElementNotThere() {
        //given
        HashTable<Double> hash = new HashQuadraticProbing<>(3, 2, 3);
        hash.put(1.0);
        hash.put(2.0);
        hash.put(3.0);
    ...
    public void DeleteTest() {
        //given
        HashTable<Double> hash = new HashQuadraticProbing<>(3, 2.5, 3);
        hash.put(1.0);
        hash.put(2.0);
        hash.put(3.0);
    ...
    public void should_NotChangeNumsWhenAddingElementThatExistsAfterDeleted() {
        //given
        HashTable<Double> hash = new HashQuadraticProbing<>(3, 2, 3.5);
        hash.put(1.0);
        hash.put(2.0);
        hash.put(3.0);
    ...
    public void DeletingFirstElementSameHashCode() {
        //given
        HashTable<Struct> hash = new HashQuadraticProbing<>(3, 2.5, 3.5);
    ...
    public void deletingAllOfElementsWithSameCode() {
        //given
        HashTable<Struct> hash = new HashQuadraticProbing<>(12, 1, 1);
    ...
    public void gettingAllOfElementsWithSameCode() {
        //given
        HashTable<Struct> hash = new HashQuadraticProbing<>(12, 2, 2);
        for (int i = 0; i < 1000; i++) {
            hash.put(new Struct(12 * i * i));
        }
